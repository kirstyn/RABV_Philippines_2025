...
#df1
old=read.csv("processed_data/processed_metadata/gathered_metadata_n797_20251020_161614.csv")


#df2
new=read.csv("processed_data/processed_metadata/gathered_metadata_n797_raddlCorrected_20251020_161614.csv")
...
create_output_table(comparedf, output_type = 'xlsx', file_name = "processed_data/processed_metadata/gathered_metadata_n797_compare.xlsx")
